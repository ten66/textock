...
function App() {
  ...
  const handleTemplateSubmit = async (data: any) => {
    ...
    try {
      ...
      if (result.error) {
        alert('エラーが発生しました: ' + (result.error.message || '不明なエラー'));
        return;
      }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 font-medium">読み込み中...</p>
        </div>
      </div>
    );
  }
        ...
        {templatesLoading ? (
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">テンプレートを読み込み中...</p>
            </div>
          </div>
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3">
              {templates.length === 0 ? 'テンプレートがありません' : 'テンプレートが見つかりません'}
            </h3>
